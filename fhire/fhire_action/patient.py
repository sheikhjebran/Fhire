...
from fhire.fhire_action.base import Base
...
class __Patient(Base):


    def parse_https_get_patient_response(self, check_obj) -> "Fhire":
        try:
    ...
    def parse_https_post_patient_response(self, check_obj) -> "Fhire":
        try:
